      ...
      <Grid container spacing={3}>
        ...
        {result && (
          <>
            ...
            {/* Relationships */}
            {result.data_relationships && result.data_relationships.length > 0 && (
              <Grid item xs={12}>
                <Card>
                  <CardContent>
                    <Typography variant="h6" gutterBottom>
                    ...
                    {result.data_relationships.map((rel, index) => (
                      <Box key={index} sx={{ mb: 1 }}>
            ...
            {/* Code Snippets */}
            {result.important_code_snippets && result.important_code_snippets.length > 0 && (
              <Grid item xs={12}>
                <Card>
                  <CardContent>
                    <Typography variant="h6" gutterBottom>
                    ...
                    {result.important_code_snippets.map((snippet, index) => (
                      <Box key={index} sx={{ mb: 2 }}>
                        ...
                        >
                          <pre style={{ margin: 0 }}>{snippet.snippet}</pre>
                          <Typography variant="body2" sx={{ mt: 1 }}>
                            {snippet.explanation}
                          </Typography>
                        </Paper>
            ...
            {/* Reuse Opportunities */}
            {result.potential_reuse_opportunities && result.potential_reuse_opportunities.length > 0 && (
              <Grid item xs={12}>
                <Card>
                  <CardContent>
                    <Typography variant="h6" gutterBottom>
                    ...
                    {result.potential_reuse_opportunities.map((opportunity, index) => (
                      <Box key={index} sx={{ mb: 1 }}>
                        <Typography variant="body1">
                          {opportunity}
                        </Typography>
